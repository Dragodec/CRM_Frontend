...
export default function CreateInteractionModal({ isOpen, onClose, customerId, onInteractionCreated }) {
  ...
  useEffect(() => {
    ...
    const fetchUsers = async () => {
      try {
        ...
        setUsers(data); // ["Alice", "Bob"]
        setFormData((prev) => ({ ...prev, createdByName: data[0] || "" }));
      } catch (err) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await apiRequest("interactions", "POST", { ...formData, customerId });
      setFormData({ type: "", details: "", createdByName: users[0] || "" });
      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            <h2 className="text-2xl font-bold text-purple-400 mb-4">Create New Interaction</h2>
