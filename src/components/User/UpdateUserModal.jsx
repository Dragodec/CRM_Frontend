// src/components/user/UpdateUserModal.jsx
import React, { useState, useEffect } from "react";
import { motion, AnimatePresence } from "framer-motion";
import { FaTimes } from "react-icons/fa";
import { apiRequest } from "../../api";

const ROLES = ["ADMIN", "ANALYST", "SALES_REP"]; // SUPER_ADMIN excluded

export default function UpdateUserModal({ isOpen, onClose, user, onUserUpdated }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // PATCH-style update (send only filled fields)
      ...
      {isOpen && user && (
        ...
        >
          ...
          >
            ...
            <h2 className="text-2xl font-bold text-purple-400 mb-4">Update User</h2>
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  onChange={handleChange}
                  className="w-4 h-4 text-purple-400 bg-gray-800 border-gray-600 rounded focus:ring-purple-400"
                />
