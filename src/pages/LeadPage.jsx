...
export default function LeadPage() {
  ...
  const fetchLeads = useCallback(async () => {
    ...
    try {
      ...
      const data = await apiRequest(`leads?${query.toString()}`);
  ...
  const handleLeadCreated = () => {
    fetchLeads(); // refresh after creation
  };
                ...
                {loading ? (
                  ...
                  leads.map((lead) => (
                    ...
                    >
                      ...
                      <td className="p-3">{lead.salesRepName || "-"}</td>
                      <td className="p-3">{lead.status}</td>
                      <td className="p-3">{lead.active ? "Yes" : "No"}</td>
                      <td className="p-3">
                        <button
        ...
        {loading ? (
          ...
          leads.map((lead) => (
            ...
            >
              ...
              <p>
                <strong>Sales Rep:</strong> {lead.salesRepName || "-"}</p>
              <p>
                <strong>Status:</strong> {lead.status}</p>
              <p>
                <strong>Active:</strong> {lead.active ? "Yes" : "No"}</p>
